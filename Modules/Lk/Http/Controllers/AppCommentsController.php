...
use Lk\Services\AppCommentService;
...
class AppCommentsController extends Controller
{
    ...
    public function __construct(public AppCommentService $commentService)
    {
    }
    ...
    /**
     * @OA\Get(
     *      path="/api/v1/lk/applications/{id}/comment/{comment_id}",
     *      operationId="getAppComment",
     *      security={{"bearerAuth":{}}},
     *      tags={"Lk|Заявки|Комментарии менеджера"},
    ...
    /**
     * @OA\Get(
     *      path="/api/v1/lk/applications/{id}/comment",
     *      operationId="getAppAllComment",
     *      security={{"bearerAuth":{}}},
     *      tags={"Lk|Заявки|Комментарии менеджера"},
