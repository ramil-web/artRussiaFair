...
use Admin\Http\Resources\Photographer\PhotographerCollection;
use Admin\Http\Resources\Photographer\PhotographerResource;
...
class PhotographerController extends Controller
{
    ...
    {
        $this->type = ParticipantTypesEnum::PHOTOGRAPHER();
    }


    /**
     * @OA\Post(
     *      path="/api/v1/admin/photographer/store",
     *      operationId="AdminPhotographerStore",
     *      security={{"bearerAuth":{}}},
     *      tags={"Admin|Фотографы"},
     *      summary="Добавление фотографа",
     *      @OA\RequestBody(
     *        required=true,
     *        @OA\MediaType(
     ...
     *               ),
     *            ),
     *            @OA\Property(property="slug", description="Уникальное поле слаг", type="ыекштп", example="slug"),
     ...
     *            @OA\Property(property="name", description="ФИО фотографа", type="object",
     *               @OA\Property(property="ru", example="Иванов Иван Василевич"),
     *               @OA\Property(property="en", example="Ivanov Ivan Ivanovich")
     *            ),
     *            @OA\Property(property="description", description="Описание фотографа", type="object",
     *                @OA\Property(property="ru", example="Фотограф"),
     *                @OA\Property(property="en", example="Photographer"),
     *            ),
     *            @OA\Property(property="image",description="Описание фотографа",type="string",example="http://newapiartrussiafair/api/v1/admin/"),
     ...
     *             @OA\Property(property="type", example="photographer", type="string"),
     ...
     *                      @OA\Property(property="en", example="Photographer")
     *                ),
     *                @OA\Property(property="image",description="Изоброжение фотографа",type="string",example="http://newapiartrussiafair/api/v1/admin/"),
     ...
     *                 @OA\Property(property="self",type="string", example="http://newapiartrussiafair/api/v1/admin/photographer/8"),
     *              ),
     *             @OA\Property(property="relationships", type="object",
     *                @OA\Property(property="events", type="object",
     *                  @OA\Property(property="data",type="object"),
     *                  @OA\Property(property="links",type="object",
     *                     @OA\Property(property="self",type="string", example="http://newapiartrussiafair/api/v1/admin/photographer/6/relationships/eventgable"),
     *                     @OA\Property(property="related",type="string",example="http://newapiartrussiafair/api/v1/admin/photographer/6/eventgable" ),
     *                  ),
     *                ),
     *              ),
     *            ),
     *                @OA\Property(property="metadata",type="object",
     *                   @OA\Property(property="message", example="Фотограф успешно добавлен"),
     *                 ),
     *               ),
     *             ),
     *           ),
    ...
    public function store(StoreParticipantRequest $request): ApiErrorResponse|ApiSuccessResponse
    {
        try {
            ...
            return new ApiSuccessResponse(
                new  PhotographerResource($this->participantService->create($dataApp)),
                ['message' => 'Фотограф успешно добавлен'],
                ResponseAlias::HTTP_OK
            );
        } catch (Throwable $exception) {
            return new ApiErrorResponse(
                'Ошибка при добавление фотографа',
                $exception
            );
        }
    }
    ...
    /**
     * @OA\Get(
     *       path="/api/v1/admin/photographer/{id}",
     *       operationId="AdminGetPhotographer",
     *       security={{"bearerAuth":{}}},
     *       tags={"Admin|Фотографы"},
     *       summary="Получить данные фотографа",
     *       @OA\Parameter(
     *         name="id",
     *         in="path",
     *         required=true,
     ...
     *                      @OA\Property(property="en", example="Photographer")
     *                   ),
     *                  @OA\Property(property="image",description="Изображение фотографа",type="string",example="http://newapiartrussiafair/api/v1/admin/"),
     *                  @OA\Property(property="stand_id",description="Номер стенда",type="string",example="2a"),
     *                  @OA\Property(property="created_at", type="sting", example="2023-11-27 15:1"),
     *                  @OA\Property(property="updated_at", type="string", example="2023-11-27 15:1"),
     *                  @OA\Property(property="deleted_at", type="string", example=null),
     ...
     *                      @OA\Property(property="eventgable_type", type="string",example="App\\Models\\photographer"),
     *                      @OA\Property(property="eventgable_id", type="integer", example="7"),
     *                  ),
     *              ),
     *           ),
     *          @OA\Property(property="links", type="object",
     *              @OA\Property(property="self",type="string", example="http://newapiartrussiafair/api/v1/admin/photographer/4"),
     *           ),
     *          @OA\Property(property="relationships", type="object",
     *             @OA\Property(property="events", type="object",
     *                @OA\Property(property="data",type="object"),
    ...
    {
        return new ApiSuccessResponse(
            new  PhotographerResource($this->participantService->show($id, $this->type)),
            ['message' => 'Ok'],
            ResponseAlias::HTTP_OK
        );
    }
    ...
    /**
     * @OA\Get(
     *       path="/api/v1/admin/photographer/all",
     *       operationId="Admin\AphotographerList",
     *       security={{"bearerAuth":{}}},
     *       tags={"Admin|Фотографы"},
     *       summary="Получить список фотографов",
     *       @OA\Parameter(
     *           name="filter[trashed]",
     *           in="query",
     ...
     * @return PhotographerCollection|ApiErrorResponse
     */
    public function list(ListParticipantRequest $request): PhotographerCollection|ApiErrorResponse
    {
        $dataApp = $request->validated();
        $dataApp['type'] = $this->type;
        try {
            return new PhotographerCollection($this->participantService->list($dataApp));
        } catch (Throwable $e) {
            return new ApiErrorResponse('Ошибка при выводе списока фотографов', $e);
        }
    }

    /**
     * @OA\Patch(
     *       path="/api/v1/admin/photographer/update/{id}",
     *       operationId="AdminPhotographerUpdate",
     *       security={{"bearerAuth":{}}},
     *       tags={"Admin|Фотографы"},
     *       summary="Редактирование данные фотографа",
     *       @OA\Parameter(
     *         name="id",
     *         in="path",
     *         required=true,
    ...
    /**
     * @OA\Delete(
     *       path="/api/v1/admin/photographer/delete/{id}",
     *       operationId="AdminPhotographerDelete",
     *       security={{"bearerAuth":{}}},
     *       tags={"Admin|Фотографы"},
     *       summary="Полностью удаление фотографа",
     *       @OA\Parameter(
     *         name="id",
     *         in="path",
     *         required=true,
    ...
    /**
     * @OA\Delete(
     *       path="/api/v1/admin/photographer/archive/{id}",
     *       operationId="AdminPhotographerArchive",
     *       security={{"bearerAuth":{}}},
     *       tags={"Admin|Фотографы"},
     *       summary="Добавить фотографа в архив",
     *       @OA\Parameter(
     *         name="id",
     *         in="path",
     *         required=true,
    ...
    /**
     * @OA\Patch(
     *    path="/api/v1/admin/photographer/restore/{id}",
     *    operationId="RestorePhotographer",
     *    security={{"bearerAuth":{}}},
     *    tags={"Admin|Фотографы"},
     *    summary="Восстановить фотографа из архива",
     *    @OA\Parameter(
     *        name="id",
     *        in="path",
     *        required=true,
     ...
     *                 @OA\Property(property="detail", example="Such an photographer does not exist in the archive."),
     *              ),
     *           ),
     *        ),
     *      ),
    ...
    public function restore(int $id): ApiSuccessResponse|ApiErrorResponse
    {
        ...
        return new ApiErrorResponse(
            'Such an photographer does not exist in the archive.',
            null,
