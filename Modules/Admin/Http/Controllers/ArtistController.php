...
class ArtistController extends Controller
{
    ...
    {
        $this->type = ParticipantTypesEnum::ARTIST();
    }


    /**
     * @OA\Post(
     *      path="/api/v1/admin/artist/store",
     *      operationId="AdminArtistStore",
     *      security={{"bearerAuth":{}}},
     *      tags={"Admin|Художники"},
     *      summary="Добавление художника",
     *      @OA\RequestBody(
     *        required=true,
     *        @OA\MediaType(
     ...
     *               ),
     *            ),
     *            @OA\Property(property="slug", description="Уникальное поле слаг", type="ыекштп", example="artist_!"),
     ...
     *            @OA\Property(property="name",description="ФИО художника",type="object",
     ...
     *            ),
     *            @OA\Property(property="image",description="Аваьар художника",type="string",example="http://newapiartrussiafair/api/v1/admin/"),
     ...
     *                    @OA\Property(property="en", example="Artist")
     *                ),
     *                @OA\Property(property="image",description="Изоброжение художника",type="string",example="http://newapiartrussiafair/api/v1/admin/"),
     ...
     *                @OA\Property(property="slug", type="string", example="artist22"),
     *                @OA\Property(property="images",description="Картинки художника",type="array",
     *                   example={
     *                     "http://newapiartrussiafair/api/v1/artist/nature.jpg",
     *                     "http://newapiartrussiafair/api/v1/artist/natureww.jpg"
    ...
    public function store(StoreParticipantRequest $request): ApiErrorResponse|ApiSuccessResponse
    {
        try {
            ...
            return new ApiSuccessResponse(
                new  ArtistResource($this->participantService->create($dataApp)),
                ['message' => 'Художник успешно добавлен'],
                ResponseAlias::HTTP_OK
            );
        } catch (Throwable $exception) {
            return new ApiErrorResponse(
                'Ошибка при добавление художника',
                $exception
            );
        }
    }
    ...
    /**
     * @OA\Get(
     *       path="/api/v1/admin/artist/{id}",
     *       operationId="AdminGetArtist",
     *       security={{"bearerAuth":{}}},
     *       tags={"Admin|Художники"},
     *       summary="Получить данные художника",
     *       @OA\Parameter(
     *         name="id",
     *         in="path",
     *         required=true,
     ...
     *                          @OA\Property(property="eventgable_type", type="string", example="App\\Models\\artist"),
    ...
    {
        return new ApiSuccessResponse(
            new  ArtistResource($this->participantService->show($id, $this->type)),
            ['message' => 'Ok'],
            ResponseAlias::HTTP_OK
        );
    }
    ...
    /**
     * @OA\Get(
     *    path="/api/v1/admin/artist/all",
     *    operationId="AdminAartistList",
     *    security={{"bearerAuth":{}}},
     *    tags={"Admin|Художники"},
     ...
     */
    public function list(ListParticipantRequest $request): ArtistCollection|ApiErrorResponse
    {
        $dataApp = $request->validated();
        $dataApp['type'] = $this->type;
        try {
            return new ArtistCollection($this->participantService->list($dataApp));
        } catch (NotFoundHttpException $e) {
            return new ApiErrorResponse('Ошибка при выводе списока художников', $e);
        }
    }

    /**
     * @OA\Patch(
     *       path="/api/v1/admin/artist/update/{id}",
     *       operationId="AdminArtistUpdate",
     *       security={{"bearerAuth":{}}},
     *       tags={"Admin|Художники"},
     *       summary="Редактирование данные художника",
     *       @OA\Parameter(
     *         name="id",
     *         in="path",
     *         required=true,
     ...
     *            ),
     *            @OA\Property(property="sort_id", description="ID сортировки", type="integer", example="1"),
     *            @OA\Property(property="type", description="Категория", type="string", example="photographer"),
     *            @OA\Property(property="slug", type="string", example="artist_1"),
     *            @OA\Property(property="stand_id",description="Номер стенда",type="string",example="2a"),
     *            @OA\Property(property="name", description="ФИО чудожника", type="object",
     *               @OA\Property(property="ru", example="Иванов Иван Василевич"),
    ...
    /**
     * @OA\Delete(
     *       path="/api/v1/admin/artist/delete/{id}",
     *       operationId="AdminArtistDelete",
     *       security={{"bearerAuth":{}}},
     *       tags={"Admin|Художники"},
     *       summary="Полностью удаление художника",
     *       @OA\Parameter(
     *         name="id",
     *         in="path",
     *         required=true,
    ...
    /**
     * @OA\Delete(
     *       path="/api/v1/admin/artist/archive/{id}",
     *       operationId="AdminArtistArchive",
     *       security={{"bearerAuth":{}}},
     *       tags={"Admin|Художники"},
     *       summary="Добавить художника в архив",
     *       @OA\Parameter(
     *         name="id",
     *         in="path",
     *         required=true,
    ...
    /**
     * @OA\Patch(
     *    path="/api/v1/admin/artist/restore/{id}",
     *    operationId="RestoreArtist",
     *    security={{"bearerAuth":{}}},
     *    tags={"Admin|Художники"},
     *    summary="Восстановить художника из архива",
     *    @OA\Parameter(
     *       name="id",
     *       in="path",
     *       required=true,
